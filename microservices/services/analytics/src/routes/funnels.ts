    ...
    try {
      ...
      res.status(201).json({
        ...
        funnel: {
          ...
          steps: funnel.steps,
          // conversionWindow: funnel.conversionWindow, // Field not in database schema
  ...
  try {
    ...
    res.json({
      funnel: {
        ...
        createdAt: funnel.createdAt,
        updatedAt: funnel.updatedAt,
        // createdBy: funnel.createdBy, // Field not in database schema
      },
    });
  } catch (error) {
    ...
    try {
      ...
      res.json({
        ...
        funnel: {
          ...
          // conversionWindow: updatedFunnel.conversionWindow, // Field not in database schema
