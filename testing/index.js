...
app.post('/firebase/messaging/send', (req, res) => {
  console.log('🔥 Firebase Push Mock - Received push request:', req.body);
...
// Firebase Webhook Mock
app.post('/webhooks/firebase', (req, res) => {
  console.log('🔥 Firebase Webhook Mock - Received webhook:', req.body);
  res.status(200).json({ message: 'Webhook received' });
});
...
app.get('/status', (req, res) => {
  res.status(200).json({
    services: {
      ...
      firebase: { status: 'active', endpoint: '/firebase/messaging/send' },
      stripe: { status: 'active', endpoint: '/stripe/v1/payment_intents' },
      webhooks: { status: 'active', endpoints: [
        '/webhooks/sendgrid',
        '/webhooks/firebase', 
        '/webhooks/stripe',
        '/webhooks/clerk',
